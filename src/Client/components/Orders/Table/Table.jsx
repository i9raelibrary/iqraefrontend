...
import { OrderDetails } from '../../../../Admin/components/OrderInfo/OrderDetailes';
    ...
    <div className="row d-flex justify-content-center mt-2">
      ...
      {showOrderDetails &&
        <Box sx={{ position: 'absolute', top: 0, left: 0, zIndex: 1500 }}>
          <OrderDetails setShowOrderDetails={setShowOrderDetails} details={details} refetch={refetch} mode={"client"}/>
        </Box>
      }
    </div>
  );
